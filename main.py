...
class App(customtkinter.CTk):
    ...
    def settings(self):
        ...
        self.optionmenu_1 = customtkinter.CTkOptionMenu(master=self.settings_frame, values=["Dark", "Light"], command=self.change_appearance_mode)
    ...
    def departure_display(self):
        ...
        self.button_search = customtkinter.CTkButton(master=self.frame_right, text="Search", width=120, command=self.view_results)
    ...
    def search_departure(self):
        ...
        self.button_ddd = customtkinter.CTkButton(
            ...
            fg_color="#C41E3A",
            hover_color="#D56376",
            command=self.close_search_deps,
            corner_radius=5,
        )
        self.button_ddd.grid(row=1, column=0, pady=5, padx=5, ipadx=60)
